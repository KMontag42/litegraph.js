...
(function(d) {
          ...
          if (!this.connecting_node && !c.flags.collapsed && !this.live_mode) {
            if (c.outputs) {
              ...
              for (var g = c.outputs.length; d < g; ++d) {
                ...
                if (f(a.canvasX, a.canvasY, t[0] - h.NODE_PORT_PADDING, t[1] - 5, 20, 10)) {
            ...
            if (c.inputs) {
              for (d = 0, g = c.inputs.length; d < g; ++d) {
                l = c.inputs[d], t = c.getConnectionPos(!0, d), f(a.canvasX, a.canvasY, t[0] - h.NODE_PORT_PADDING, t[1] - 5, 20, 10) && null !== l.link && (c.disconnectInput(d), e = this.dirty_bgcanvas = !0);
              }
            }
            !e && f(a.canvasX, a.canvasY, c.pos[0] + c.size[0] - h.NODE_PORT_PADDING / 2, c.pos[1] + c.size[1] - h.NODE_PORT_PADDING / 2, 5, 5) && (this.resizing_node = c, this.canvas.style.cursor = "se-resize", e = !0);
          }
          !e && f(a.canvasX, a.canvasY, c.pos[0], c.pos[1] - h.NODE_TITLE_HEIGHT, 10, 10) && (c.collapse(), e = !0);
          if (!e) {
            d = !1;
  ...
  LGraphCanvas.prototype.computeConnectionPoint = function(a, b, c) {
    ...
    d = [b[0] - 0.25 * d, b[1]];
    var g = (1 - c) * (1 - c) * (1 - c), h = 3 * (1 - c) * (1 - c) * c, l = 3 * (1 - c) * c * c;
    c *= c * c;
    return [g * a[0] + h * f[0] + l * d[0] + c * b[0], g * a[1] + h * f[1] + l * d[1] + c * b[1]];
  };
